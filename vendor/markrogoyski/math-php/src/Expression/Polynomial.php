...
namespace Sparkair\MathPHP\Expression;

use Sparkair\MathPHP\Algebra;
use Sparkair\MathPHP\Exception;
use Sparkair\MathPHP\Functions\Arithmetic;
use Sparkair\MathPHP\Functions\Map;
use Sparkair\MathPHP\LinearAlgebra\MatrixFactory;
use Sparkair\MathPHP\LinearAlgebra\NumericSquareMatrix;
use Sparkair\MathPHP\LinearAlgebra\Vector;
use Sparkair\MathPHP\Number\Complex;
use Sparkair\MathPHP\Number\ObjectArithmetic;
/**
