...
namespace Sparkair\MathPHP\Statistics;

use Sparkair\MathPHP\Exception;
use Sparkair\MathPHP\Functions\Map;
use Sparkair\MathPHP\LinearAlgebra\Eigenvalue;
use Sparkair\MathPHP\LinearAlgebra\Eigenvector;
use Sparkair\MathPHP\LinearAlgebra\NumericMatrix;
use Sparkair\MathPHP\LinearAlgebra\MatrixFactory;
use Sparkair\MathPHP\Probability\Distribution\Continuous\ChiSquared;
use Sparkair\MathPHP\Probability\Distribution\Continuous\StandardNormal;
use Sparkair\MathPHP\Trigonometry;
/**
