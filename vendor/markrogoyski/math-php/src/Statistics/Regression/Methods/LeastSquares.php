...
namespace Sparkair\MathPHP\Statistics\Regression\Methods;

use Sparkair\MathPHP\Exception\BadDataException;
use Sparkair\MathPHP\Exception\BadParameterException;
use Sparkair\MathPHP\Exception\IncorrectTypeException;
use Sparkair\MathPHP\LinearAlgebra\MatrixFactory;
use Sparkair\MathPHP\Statistics\RandomVariable;
use Sparkair\MathPHP\Functions\Map\Single;
use Sparkair\MathPHP\Functions\Map\Multi;
use Sparkair\MathPHP\Probability\Distribution\Continuous\F;
use Sparkair\MathPHP\Probability\Distribution\Continuous\StudentT;
use Sparkair\MathPHP\LinearAlgebra\NumericMatrix;
use Sparkair\MathPHP\Exception;
trait LeastSquares
{
    /**
     * Regression ys
