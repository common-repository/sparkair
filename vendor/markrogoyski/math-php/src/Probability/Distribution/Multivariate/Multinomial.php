...
namespace Sparkair\MathPHP\Probability\Distribution\Multivariate;

use Sparkair\MathPHP\Probability\Combinatorics;
...
class Multinomial
{
    ...
    public function pmf(array $frequencies) : float
    {
        ...
        $x₁！⋯xk！ = \array_product(\array_map('Sparkair\\MathPHP\\Probability\\Combinatorics::factorial', $frequencies));
